	...
	<section class="centers_sec">
		...
		<div class="steps_wrap">
			...
			<div class="row centers_row">
				...
				<?php $title_m = get_field('center_page_message_title' , 'option'); ?>
				<?php $con_m = get_field('center_page_message_content' , 'option'); ?>
			...
			<!--=======       M E S S A G E   A F T E R     ========-->
			<!-- 			
			<div class="row centers_row_thanks">
				<div class="thanks_message">
					<h4>Thank you!</h4>
					<p class="p_sec">
						You are suitable for focused ultrasound treatment
					</p>
				</div>
			</div> -->
